...
<div class="container justify-content-center" align="center">
    <div class="card">
        <div class="p-4 card-body w-1/2">
            ...
            <p class="text-lg text-left align-text-bottom italic text-gray-400">finished in hh:mm:ss</p>
            <div class="p-4 my-1 card-body rounded-lg bg-pink-200 drop-shadow-md items-center">
                <div class="m-2 px-4 py-2 card-body rounded-lg bg-pink-100 drop-shadow-md">
                    <div class="flex justify-between">
                        <div>
                            <h1 class="text-4xl font-bold text-left">Score:</h1>
                        </div>
                        <div class="flex">
                            <h1 class="text-4xl text-right">50/50</h1>
                            <h1 class="ml-2 text-4xl text-right font-light italic text-gray-400">(100%)</h1>
                        </div>
                    </div>
                </div>
